    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                if (response.data && response.data.data.distributor) {
                    const { name, rating, totalDeliveries } =
                        response.data.data.distributor;
                    setDistributorData({
                        name,
                        rating,
                        totalDeliveries,
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="font-medium text-white">
                                        {distributorData.rating.average.toFixed(
                                            1,
                                        )}
                                        /5.0 ({distributorData.rating.count}{" "}
                                        reviews)
                                    </span>
                                </div>
                            </div>
                    ...
                    <div className="bg-indigo-900 rounded-lg shadow-lg p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center">
                                ...
                                <span className="font-medium text-white">
                                    {distributorData.totalDeliveries} deliveries
                                </span>
                            </div>
                        </div>
                    </div>
