...
const ProviderAddFood = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await provider.supplyFood(
                validItems,
                location.latitude,
                location.longitude,
                foodPhoto,
            ...
            setError(
                err.response?.data?.message ||
                    "Failed to add food items. Please try again.",
            );
        }
    };
                ...
                <div className="bg-indigo-950 rounded-xl shadow-lg p-8">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        {foodItems.map((item, index) => (
                            <div
                                key={index}
                                className="border-2 border-indigo-900 rounded-xl p-6 space-y-6 hover:border-emerald-500/30 transition-all duration-300"
                            >
